  ...
  return (
    <section id="about" className="py-20 bg-linear-to-br from-orange-50 via-amber-50 to-yellow-50">
      <div className="max-w-7xl mx-auto px-4 md:px-8 lg:px-16 xl:px-24">
        ...
        <div ref={contentRef as React.RefObject<HTMLDivElement>} className={`grid lg:grid-cols-3 gap-8 mb-16 transition-all duration-1000 delay-200 transform ${contentVisible ? 'opacity-100 scale-100' : 'opacity-0 scale-75'}`}>
          <div className="lg:col-span-2 space-y-6">
            ...
            <div ref={statsRef as React.RefObject<HTMLDivElement>} className={`grid md:grid-cols-2 gap-6 mt-8 transition-all duration-1000 delay-400 transform ${statsVisible ? 'opacity-100 translate-y-0 scale-100' : 'opacity-0 translate-y-10 scale-95'}`}>
        ...
        <div ref={achievementsRef as React.RefObject<HTMLDivElement>} className={`grid md:grid-cols-2 lg:grid-cols-4 gap-8 transition-all duration-1000 delay-300 ${achievementsVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
